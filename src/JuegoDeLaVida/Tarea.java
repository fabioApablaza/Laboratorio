...
public class Tarea implements Runnable {
    ...
    private CyclicBarrier barrera, barreraEvol;

    public Tarea(int identificador, int rondas, int columnaI, int columnaF, Celula[][] mun, CyclicBarrier bar, CyclicBarrier barEvol) {
